...
export function ReckoningSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      {/* Top banner: THE RECKONING™ */}
      <div className="bg-[#01325D] py-10 sm:py-14 lg:py-16 text-center">
        <FadeIn direction="up" delay={0}>
          <h2
            className="font-serif font-bold text-white text-[28px] sm:text-[36px] lg:text-[40px] uppercase tracking-wide mb-3"
            style={{ fontVariationSettings: "'GRAD' 0, 'wdth' 100" }}
          >
            The Reckoning<span className="text-[18px] sm:text-[22px] align-super">™</span>
          </h2>
          <p className="font-mono font-medium text-white/80 text-[15px] sm:text-[17px] lg:text-[18px] mb-2">
            A moment of truth. A display of power.
          </p>
          <p className="font-mono font-normal text-white/60 text-[13px] sm:text-[14px] max-w-[600px] mx-auto px-4">
            At Kid Explorer Club, The Reckoning Day™ is where learning becomes visible.
            Every student steps forward to demonstrate what they&apos;ve built, mastered, and become.
          </p>
        </FadeIn>
      </div>

      {/* Program-specific hero with overlay */}
      <div className="relative min-h-[400px] sm:min-h-[480px] lg:min-h-[560px]">
        <Image
          src={targetProgram.image}
          alt={`${targetProgram.title} — ${targetProgram.reckoningName}`}
          fill
        ...
        <div className="relative z-10 flex min-h-[400px] sm:min-h-[480px] lg:min-h-[560px] flex-col items-center justify-center px-4 pb-14 pt-20 sm:px-8 sm:pb-16 sm:pt-24 lg:px-10 lg:py-24">
            ...
            <FadeIn direction="up" delay={0}>
              <div className="rounded-[20px] border border-white/15 bg-black/40 px-6 py-8 shadow-[0_24px_64px_rgba(0,0,0,0.45)] backdrop-blur-md sm:rounded-[28px] sm:px-10 sm:py-10 lg:px-12 lg:py-12">
                <div className="flex flex-col items-center gap-5 sm:gap-6 text-center">
                  ...
                  <h3
                    className="font-serif font-bold text-white text-[28px] leading-[1.15] tracking-tight sm:text-[38px] lg:text-[46px]"
                    style={{
                      textShadow:
                  ...
                  >
                    {targetProgram.reckoningTagline}
                  </p>
