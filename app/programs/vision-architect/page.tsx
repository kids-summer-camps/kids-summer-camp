    ...
    <div className="min-h-screen bg-white">
        ...
        <section className="relative">
          ...
          <div className="absolute left-6 sm:left-12 lg:left-[89px] top-[461px] z-30 w-[239px] hidden md:block">
            ...
            <div className="bg-[#044e8e] h-[252px] w-full flex flex-col justify-end p-4">
              <h1 className="font-serif font-bold text-[32px] text-white leading-tight">Vision</h1>
              <h2 className="font-serif font-bold text-[32px] text-white leading-tight">Architect</h2>
            </div>
            ...
            <div className="bg-white py-4 mt-3">
              ...
              <div className="border-t border-[#d9d9d9] pt-4 mb-4">
                ...
                <p className="font-mono font-normal text-black text-[20px]">Rising 4th – 7th</p>
              </div>
        ...
        <div className="md:hidden bg-white py-6 px-6">
          <div className="bg-[#044e8e] p-4">
            <h1 className="font-serif font-bold text-[24px] text-white leading-tight">Vision</h1>
            <h2 className="font-serif font-bold text-[24px] text-white leading-tight">Architect</h2>
          </div>
          <div className="mt-3">
          ...
          <div className="space-y-3 mt-3">
            ...
            <div className="border-t border-[#d9d9d9] pt-3">
              ...
              <p className="font-mono font-normal text-black text-[16px]">Rising 4th – 7th</p>
            </div>
            <div className="border-t border-[#d9d9d9] pt-3">
            ...
            <div className="ml-0 lg:ml-[320px]">
              ...
              <div id="overview" className="mb-16">
                ...
                <h2 className="font-serif font-bold text-[#01325D] text-3xl sm:text-4xl lg:text-[40px] uppercase leading-tight mb-8">
                  Vision Architect - The Plug Club
                </h2>
