...
export default function EngineeringMakerPage() {
  ...
  const mainTitle = titleParts[0]; // "Engineering"
        ...
        <div className="w-full mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 2xl:px-[10%]">
          ...
          <div className="ml-0 lg:ml-[320px]">
            ...
            <div id="why-different" className="mb-16">
              ...
              <p className="font-mono font-normal text-black text-sm sm:text-base leading-relaxed mb-6">
                Our Engineering Maker Camp transforms campers into inventors. Through hands-on projects spanning mechanical, electrical, and civil engineering, kids learn to see problems as opportunities for innovation.
              </p>
              <p className="font-mono font-normal text-black text-sm sm:text-base leading-relaxed mb-6">
                Using real tools and materials, campers prototype inventions, test structures, and develop engineering thinking. Every failed bridge or short circuit becomes a lesson in persistence and problem-solving.
              </p>
              ...
              <p className="font-mono font-normal text-black text-sm sm:text-base leading-relaxed">
                We&apos;re not raising campers. We&apos;re raising engineers, makers, and innovators—future legends in the making.
              </p>
            </div>
            ...
            <div id="projects" className="mb-16">
              ...
              <ul className="list-disc pl-6 space-y-3 font-mono font-normal text-black text-sm sm:text-base leading-relaxed mb-8">
                <li>Structural bridges using real engineering principles</li>
                <li>Working circuits and electronic devices</li>
                <li>3D-printed mechanical parts and prototypes</li>
                <li>Towers and buildings tested against simulated forces</li>
                <li>Custom inventions solving real-world challenges</li>
              </ul>

              <p className="font-mono font-normal text-black text-sm sm:text-base leading-relaxed mb-6">
                Every camper uses authentic maker tools including soldering irons, 3D printers, and circuit components. Safety training is integrated into every activity, and our experienced instructors ensure proper technique while encouraging experimentation.
              </p>
            </div>
            ...
            <div id="notes" className="mb-16">
              ...
              <ul className="list-disc pl-6 space-y-2 font-mono font-normal text-black text-sm sm:text-base leading-relaxed mb-8">
                <li>All tools, materials, and safety equipment are provided.</li>
                <li>Comprehensive safety training precedes all tool usage.</li>
                <li>Low camper-to-instructor ratio ensures close supervision.</li>
                <li>Projects are designed to be completed and taken home.</li>
                <li>Camp culminates in an Engineering Expo where campers display their inventions.</li>
              </ul>
