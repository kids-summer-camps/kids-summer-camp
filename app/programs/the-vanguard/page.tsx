    ...
    <div className="min-h-screen bg-white">
        ...
        <section className="relative">
          ...
          <div className="absolute left-6 sm:left-12 lg:left-[89px] top-[461px] z-30 w-[239px] hidden md:block">
            ...
            <div className="bg-[#23ddd1] h-[252px] w-full flex flex-col justify-end p-4">
              ...
              <h2 className="font-serif font-bold text-[40px] text-white leading-none">Vanguard</h2>
            </div>
            ...
            <div className="bg-white py-4 mt-3">
              ...
              <div className="border-t border-[#d9d9d9] pt-4 mb-4">
                ...
                <p className="font-mono font-normal text-black text-[20px]">Rising 8th</p>
              </div>
        ...
        <div className="md:hidden bg-white py-6 px-6">
          <div className="bg-[#23ddd1] p-4">
            ...
            <h2 className="font-serif font-bold text-[32px] text-white leading-none">Vanguard</h2>
          </div>
          <div className="mt-3">
          ...
          <div className="space-y-3 mt-3">
            ...
            <div className="border-t border-[#d9d9d9] pt-3">
              ...
              <p className="font-mono font-normal text-black text-[16px]">Rising 8th</p>
            </div>
            <div className="border-t border-[#d9d9d9] pt-3">
              ...
              <div id="overview" className="mb-16">
                ...
                <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[480px] mb-8 rounded-[5px] overflow-hidden">
                  <video
                    ...
                    playsInline
                    preload="none"
                    poster="/images/the-vanguard-video.png"
                    className="w-full h-full object-cover"
                  >
                    <source src="/videos/lack%20woman%20astronaut.MP4" type="video/mp4" />
                  </video>
